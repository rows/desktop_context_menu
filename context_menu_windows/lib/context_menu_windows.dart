...
const MethodChannel _channel = MethodChannel('context_menu_windows');

class ContextMenuWindows extends ContextMenuPluginPlatform {
  @visibleForTesting
  ...
  static void registerWith() {
    ContextMenuPluginPlatform.instance = ContextMenuWindows();
  }
